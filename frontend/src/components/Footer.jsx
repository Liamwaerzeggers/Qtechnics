        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/werkwijze" className="text-white/80 hover:text-white transition-colors text-sm">Werkwijze</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="tel:+32494808021" className="flex items-center text-white/80 hover:text-white transition-colors text-sm">
