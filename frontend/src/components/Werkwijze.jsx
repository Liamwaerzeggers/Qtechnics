        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="relative">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-[#4a3728] mb-3">Kennismaking</h3>
          ...
          <div className="relative">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-[#4a3728] mb-3">Ontwerp & Offerte</h3>
              <p className="text-[#6a5748] leading-relaxed">
          ...
          <div className="relative">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-[#4a3728] mb-3">Uitvoering</h3>
              <p className="text-[#6a5748] leading-relaxed">
          ...
          <div className="relative">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-[#4a3728] mb-3">Oplevering</h3>
              <p className="text-[#6a5748] leading-relaxed">
