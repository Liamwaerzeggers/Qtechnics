...
const ProjectDetail = () => {
  ...
  const heroStyle = {
    backgroundImage: 'url(' + getUrl(project.mainImage) + ')'
  };
    ...
    <div>
      <div className="bg-gray-50 border-b py-4">
        <div className="max-w-7xl mx-auto px-4">
          <Link to="/projecten" className="inline-flex items-center text-[#3a190b]">
      ...
      <div className="relative h-96 bg-cover bg-center" style={heroStyle}>
        <div className="absolute inset-0 bg-black/40" />
        <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/70">
          <div className="max-w-7xl mx-auto">
            <span className="inline-block bg-[#3a190b] text-white text-xs px-3 py-1 rounded mb-4">
              {project.category}
            </span>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div>
            <div className="bg-gray-50 rounded-lg p-6 sticky top-24">
              ...
              <Link to="/start">
                <Button className="w-full bg-[#3a190b] text-white">Start uw project</Button>
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-[#3a190b]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link to="/start">
            <Button className="bg-white text-[#3a190b]">Gratis plaatsbezoek</Button>
          </Link>
        </div>
      </section>
    </div>
