    ...
    <section className="relative min-h-[600px] md:min-h-[700px] flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-2xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#202020] leading-tight mb-6">
            Totaalrenovaties & interieurbouw met{' '}
            <span className="text-[#3a190b]">technische expertise</span>
          </h1>
          <p className="text-lg md:text-xl text-[#202020]/80 mb-8 leading-relaxed">
